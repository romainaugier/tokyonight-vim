...
let s:configuration.enable_italic = 1
...
call s:HL('ToolbarLine', s:palette.fg, s:palette.bg1)
endif
...
call s:HL('CursorLine', s:palette.fg, s:palette.bg1)
...
call s:HL('Keyword', s:palette.purple, s:palette.none, 'italic')
